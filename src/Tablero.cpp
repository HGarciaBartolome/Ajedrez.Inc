...
void Tablero::dibuja2() {
	...
	glBegin(GL_POLYGON);
	glColor3f(1, 1, 1);
	glTexCoord2d(0, 1); glVertex3f(-15, -60, -6);
	glTexCoord2d(1, 1); glVertex3f(15, -60, -6);
	glTexCoord2d(1, 0); glVertex3f(15, 65, -6);
	glTexCoord2d(0, 0); glVertex3f(-15, 65, -6);
	glEnd();
	glEnable(GL_LIGHTING);
	glDisable(GL_TEXTURE_2D);
...
void Tablero::dibuja3() {
	...
	glBegin(GL_POLYGON);
	glColor3f(1, 1, 1);
	glTexCoord2d(0, 1); glVertex3f(-14, -40, -7);
	glTexCoord2d(1, 1); glVertex3f(14, -40, -7);
	glTexCoord2d(1, 0); glVertex3f(15, 40, -6);
	glTexCoord2d(0, 0); glVertex3f(-15, 40, -6);
	glEnd();
	glEnable(GL_LIGHTING);
	glDisable(GL_TEXTURE_2D);
...
void Tablero::hacerMovimiento(Vector2D aux)
{
	...
	if (mov) {
		...
		////Explicacciones de los movimientos ajedrez ETSIDI
		//fichasETSIDI(casilla[piezaActual->getPosicionX()][piezaActual->getPosicionY()].getPieza()->tipoPieza());
